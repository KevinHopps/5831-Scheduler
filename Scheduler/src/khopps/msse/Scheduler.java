...
public class Scheduler
{
	...
	/**
	 * This is the main program. It generates two workloads as specified in the
	 * assignment, and attempts to schedule them.
	 */
	private static int s_listIndex = 0;
	...
	public static void main(String[] args)
	{
		...
		Workload workload;
		while ((workload = getWorkload()) != null)
		{
...
80.2.10.60b |     |     |     |   xx|     |     |     |     |     |     |     |     |     |     |     |     |
	 ...
	 */
	private static void showSchedule(Workload workload, Task[] schedule)
	{
	 ...
	 * @param schedule
	 */
	private static void verifySchedule(Workload workload, Task[] schedule)
	{
		Task[] tasks = workload.tasks();
	 ...
	 */
	private static Workload getWorkload()
	{
